...
eve(fai_operazione):-write('sto spedendo una lettera'),nl,a(operazione_terminata).

a(operazione_terminata):-write('ho terminato'),biglietto(var_Id,var_Biglietto),nl,a(message(agentSpedizione,send_message(termino_operazione(var_Id,var_Biglietto),var_Me))),retract(biglietto(var_Id,var_Biglietto)).
