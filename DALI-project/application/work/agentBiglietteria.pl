...
eve(distribuisci_biglietti(var_Elem1,var_Elem2,var_Elem3,var_Elem4,var_Elem5,var_Elem6)):-assert(lista_biglietto(var_Elem1,var_Elem2,var_Elem3,var_Elem4,var_Elem5,var_Elem6)),lista_biglietto(var_Elem1,var_Elem2,var_Elem3,var_Elem4,var_Elem5,var_Elem6),format('Cliente 1 biglietto: ~d',var_Elem1),nl,a(message(agentCliente1,send_message(sveglia(1,var_Elem1),var_Me))),format('Cliente 2 biglietto: ~d',var_Elem2),nl,a(message(agentCliente2,send_message(sveglia(2,var_Elem2),var_Me))),format('Cliente 3 biglietto: ~d',var_Elem3),nl,a(message(agentCliente3,send_message(sveglia(3,var_Elem3),var_Me))),format('Cliente 4 biglietto: ~d',var_Elem4),nl,a(message(agentCliente4,send_message(sveglia(4,var_Elem4),var_Me))),format('Cliente 5 biglietto: ~d',var_Elem5),nl,a(message(agentCliente5,send_message(sveglia(5,var_Elem5),var_Me))),format('Cliente 6 biglietto: ~d',var_Elem6),nl,a(message(agentCliente6,send_message(sveglia(6,var_Elem6),var_Me))),retract(lista_biglietto(var_Elem1,var_Elem2,var_Elem3,var_Elem4,var_Elem5,var_Elem6)).
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_38803,var_Ontology,_38807),_38797),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_38841)),a(message(var_Ag,propose(var_A,[_38841],var_AgI))),retractall(ext_agent(var_Ag,_38879,var_Ontology,_38883)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_38677,var_Ontology,_38681),_38671),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_38747,var_Ontology,_38751)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_38565,var_Ontology,_38569),_38559),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_38621,var_Ontology,_38625)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_38129),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_38163),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_37945).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_37793),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_37741),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_37617,_37619)),clause(agente(_37639,_37641,_37643,var_S),_37635),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_37411,_37413,_37415,var_S),_37407),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_37511,[]),repeat,read(_37511,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_37511).
